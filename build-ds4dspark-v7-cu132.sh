...
# DS4 DSpark v7 validation image.
#
# vLLM:
# - local-inference-lab/vllm codex/ds4dspark-v7-pr60-20260628
#   @ ea45be31552df833b956d24b4eb814829c5ec68d
# - based on codex/eldritch-enlightenment-release-20260627 @ 67e95e7
# - includes PR #60: DCP support for FLASHINFER_MLA_SPARSE_SM120.
# - includes PR #61: DeepSeek V4 DSpark speculative decoding.
#
# B12X:
...
export IMAGE="${IMAGE:-voipmonitor/vllm:ds4dspark-v7-vea45be3-pr60-b12x284a2ea-cu132-20260628}"
...
export VLLM_REF="${VLLM_REF:-codex/ds4dspark-v7-pr60-20260628}"
export VLLM_COMMIT="${VLLM_COMMIT:-ea45be31552df833b956d24b4eb814829c5ec68d}"
export VLLM_PATCH_URL="${VLLM_PATCH_URL:-}"
export VLLM_PATCH_SHA256="${VLLM_PATCH_SHA256:-}"
export VLLM_BUILD_VERSION="${VLLM_BUILD_VERSION:-0.11.2.dev279+ds4dspark.v7.ea45be3.b12x284a2ea.fi25dd814.cu132.20260628}"
...
FLASHINFER_WHEEL_STASH=".tmp-flashinfer-wheels.disabled-ds4dspark-v7-20260628"
