...
export VLLM_COMMIT="${VLLM_COMMIT:-3db3c6860d06252b62f60a315225b6fd6ad515fb}"
export VLLM_PATCH_URL=
export VLLM_PATCH_SHA256=
export VLLM_PATCH_FILE=
export VLLM_BUILD_VERSION="${VLLM_BUILD_VERSION:-0.11.2.dev280+fathomless.firmament.ds4.v10.vllm3db3c68.b12x90172a5.fi2cba2f7.cu132.20260711}"
