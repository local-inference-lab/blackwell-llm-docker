...
# Eldritch full-stack validation build.
#
# vLLM:
# - local-inference-lab/vllm codex/eldritch-fullstack-20260625
#   @ 91bc46dbc5cb16c6a73976368925c2e0f02a7eb4
# - based on dev/eldritch-enlightenment @ 2d040b9f81
# - includes the current local eldritch PR stack for GLM/DCP, DS4F,
#   Kimi/MiMo parser/DFlash support, plus selected upstream correctness and
#   performance PRs requested for this validation pass.
#
# B12X:
...
export IMAGE="${IMAGE:-voipmonitor/vllm:eldritch-fullstack-v91bc46d-b12x284a2ea-cu132-20260625}"
...
export VLLM_REF="${VLLM_REF:-codex/eldritch-fullstack-20260625}"
export VLLM_COMMIT="${VLLM_COMMIT:-91bc46dbc5cb16c6a73976368925c2e0f02a7eb4}"
export VLLM_PATCH_URL="${VLLM_PATCH_URL:-}"
export VLLM_PATCH_SHA256="${VLLM_PATCH_SHA256:-}"
export VLLM_BUILD_VERSION="${VLLM_BUILD_VERSION:-0.11.2.dev279+eldritch.fullstack.91bc46d.b12x284a2ea.fi25dd814.cu132.20260625}"
...
FLASHINFER_WHEEL_STASH=".tmp-flashinfer-wheels.disabled-eldritch-fullstack-20260625"
