...
# Clean GG v20 test stack. The direct MXFP8 absorb work is intentionally absent:
#   excluded: vLLM #154, vLLM #157, SparkInfer #62
#   included vLLM: #145, #149, #150, #153, #155, #156
#   included SparkInfer: #57, #59, #60, #63
export IMAGE="${IMAGE:-local/vllm:gilded-gnosis-v20-test-vllmecd2bfd-si9ab5793-fi801d57a-cu132-20260721}"
...
export VLLM_REF="${VLLM_REF:-build/gilded-gnosis-v20-test-all-prs-20260721}"
export VLLM_COMMIT="${VLLM_COMMIT:-ecd2bfdf2df8d2ed2b341efb1b90e6e1a8d4e0e4}"
export VLLM_BUILD_VERSION="${VLLM_BUILD_VERSION:-0.11.2.dev280+gilded.gnosis.v20.test.vllmecd2bfd.si9ab5793.fi801d57a.cu132.20260721}"
export VLLM_PATCH_URL=
export VLLM_PATCH_SHA256=
export VLLM_PATCH_FILE=

# The generic builder retains B12X_* as compatibility aliases.
export B12X_REPO="${B12X_REPO:-https://github.com/local-inference-lab/sparkinfer.git}"
export B12X_REF="${B12X_REF:-build/sparkinfer-v20-test-all-prs-20260721}"
export B12X_COMMIT="${B12X_COMMIT:-9ab5793fc5f08eb7f2e1724da2022664626ad6ea}"
...
export LAUNCHER_COMMIT="${LAUNCHER_COMMIT:-01f8a313fcb697b80317fd264eb871b8af2cf889}"
...
[[ "${cache_fingerprint}" =~ ^vllmecd2bfdf2d-b12x9ab5793fc5-[0-9a-f]{16}$ ]]
...
assert importlib.util.find_spec("sparkinfer.gemm.qbmm_absorb") is None
...
print("v20 selected runtime contracts: PASS")
PY

dry_run_file="/tmp/gilded-gnosis-v20-test-dcp1.txt"
