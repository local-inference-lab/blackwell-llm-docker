...
# plus B12X fused paged-indexer int64 page-offset fix.
#
# vLLM:
...
#   @ 15cd38ce3f10ee5cb7db1179cbc7c88fd15e37b7
# - includes PR #20: fused paged indexer uses 64-bit page byte offsets.
#
# This is a clean source build. It does not use a runtime overlay and does not
# use VLLM_PATCH_URL.

export IMAGE="${IMAGE:-voipmonitor/vllm:eldritch-enlightenment-v8722ac7-b12x15cd38c-cu132-20260629}"
...
export B12X_REF="${B12X_REF:-15cd38ce3f10ee5cb7db1179cbc7c88fd15e37b7}"
export B12X_COMMIT="${B12X_COMMIT:-15cd38ce3f10ee5cb7db1179cbc7c88fd15e37b7}"
...
export VLLM_BUILD_VERSION="${VLLM_BUILD_VERSION:-0.11.2.dev279+eldritch.enlightenment.8722ac7.b12x15cd38c.fi25dd814.cu132.20260629}"
...
FLASHINFER_WHEEL_STASH=".tmp-flashinfer-wheels.disabled-eldritch-head66-pr20-20260629"
